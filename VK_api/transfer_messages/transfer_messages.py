    ...
    for message in handled_messages:
        if 'reply_to' in message or message['text'] != '':
            ...
            text = '<strong>' + decorator * message['level'] + message['sender'] + '</strong>' + '\n' + message[
                'text'] + '\n'
            if 'reply_to' in message: text += '<i>^ Ответ на сообщение от ' + '<strong>' + message[
        ...
        for attachment in message['attachments']:
            match (attachment['type']):
                case 'photo':
                    ...
                    await bot.send_photo(NEWS_CHAT, attachment['url'],
                ...
                case 'doc':
                    ...
                    await bot.send_document(NEWS_CHAT, (attachment['title'], r),
                ...
                case 'video':
                    ...
                    if attachment['by_direct']:
                        await bot.send_video(NEWS_CHAT, attachment['url'],
                                             caption=decorator * message['level'] + 'Видео от: ' + '<strong>' + message[
                                                 'sender'] + '</strong>', parse_mode='HTML')
                    else:
                        await bot.send_message(NEWS_CHAT, text=decorator * message['level'] + '<a href="' + attachment[
                ...
                case "audio":
                    ...
                    r = http.request('GET', attachment['url']).data
                    await bot.send_audio(NEWS_CHAT, r, performer=attachment['artist'], title=attachment['title'],
                ...
                case 'audio_message':
                    ...
                    await bot.send_voice(NEWS_CHAT, attachment['link_ogg'], caption=decorator * message[
                ...
                case 'undefined':
                    await bot.send_chat_action(NEWS_CHAT, types.ChatActions.TYPING)
                    await bot.send_message(NEWS_CHAT, text='<strong>' + decorator * message['level'] + message[
